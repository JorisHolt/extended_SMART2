...
|----|----|----|----|----|
| **Medical History** |  |  |  |  |
| Heart Failure | — | 0.52701 | 1.69 | [1.63-1.76] |
| Atrial Fibrillation | — | 0.25595 | 1.25 | [1.25-1.34] |
| Coronary Multivessel Disease | — | 0.34615 | 1.41 | [1.37-1.46] |
| **Physical Measurements** |  |  |  |  |
| BMI | Original | -0.12094 | 0.89 |  |
...
| **Laboratory & Imaging** |  |  |  |  |
| Troponin I | log | 0.11352 | 1.12 | [1.09-1.16] |
| NTproBNP | log | 0.15878 | 1.17 | [1.13-1.22] |
...
| **Physical Measurements** |  |  |
| BMI | 27.89 kg/m² | Population mean |
| BMI Squared | 778.44 | Population mean of squared values |
| Hip Circumference | 103.82 cm | Population mean |
| Hip Circumference Squared | 10,785.32 | Population mean of squared values |
| Waist Circumference | 99.75 cm | Population mean |
| **Social & Family History** |  |  |
...
| Pack Years (log) | 0.500 | Population mean of log-transformed values |
| **Laboratory & Imaging** |  |  |
| Troponin I (log) | 1.654 | Population mean of log-transformed values |
| NTproBNP (log) | 5.256 | Population mean of log-transformed values |
...
shr_troponin_i <- 1.12
log_shr_troponin_i <- log(shr_troponin_i)  # 0.03722261

# Population mean and patient values
log_mean_troponin_i <- 1.7  # log(troponin ng/L)
...
recalculate_smart2_risk <- function(data, smart2_riskcolumn, predictor){
  ...
  risk_factors_and_prevalence <- tibble::tibble(
    ...
    sdh_log = c(
      ...
      0.11352 ,    # troponin_i_log
      0.15878,    # ntprobnp_log
      0.35281      # albuminuria
    ),
    
    prevalence = c(
      0.0741147485734872,      # history_chf
      0.10419192455318,      # history_af
      0.49683648225584  ,      # multivessel
      27.8941228851291,      # bmi
      778.439990763428  ,      # bmi_squared
      103.816392718746  ,      # hip
      10785.3216578481,      # hip_squared
      99.7531483207188  ,      # waist
      ...
      1.65396328517754  ,      # troponin_i_log
      5.25618594566353  ,      # ntprobnp_log
